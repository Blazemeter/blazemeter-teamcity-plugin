...
public class TestResultFactory {
    ...
    private BzmServiceManager.ApiVersion version =null;
    ...
    public TestResult getTestResult(JSONObject json) throws IOException, JSONException {
        if(version==null){
            version= BzmServiceManager.ApiVersion.v3;
        }
        try{
            switch (version) {
                case v2:
    ...
    public BzmServiceManager.ApiVersion getVersion() {
        return version;
    }

    public void setVersion(BzmServiceManager.ApiVersion version) {
